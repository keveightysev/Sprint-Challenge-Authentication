...
It hashes passwords multiple times making it more difficult for an attacker to decrypt passwords

1. What does bcrypt do to slow down attackers?

Ha. See above. To add on, it also allows manual salting and lets you choose how many rounds it hashes the password.
